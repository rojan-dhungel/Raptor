    ...
    return (
        <>
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col" id='para'>
                        ...
                        <p>In the realm of rapid fashion trends, we hold the belief that taking whatever steps you can is the most effective starting point.</p>
                        <p>The fashion industry faces a significant and challenging journey towards becoming one that doesn't negatively impact our planet or its inhabitants. While we acknowledge that we're not flawless, we remain dedicated to constant improvement.</p>
                        <p>I'm implementing both significant and minor adjustments, and I'll ensure to provide you with updates on my progress.</p>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col" id='para'>
                        <p>Here at RAPTOR, we strongly champion the "fewer, better" philosophy towards clothing. Invest in fewer, yet exceptional pieces.</p>
                        <p>Apparel designed to transition seamlessly through seasons, remaining timeless regardless of the passing years.</p>
                        <p>I encourage you to curate a wardrobe with fewer, yet all exquisite, pieces.</p>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col" id='para'>
                        ...
                        <p>Every design I create is crafted for longevity. I don't adhere to fast fashion trends or succumb to the pressures of producing large collections.</p>
            ...
            <div className="container">
                <div className="row">
                    <div className="col" id='para'>
                        <p>I collaborate with various specialized factories for our clothing production, encompassing expertise in denim, knitwear, and digital printing. These facilities are situated in both China and Hong Kong, ensuring diverse capabilities.</p>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col" id='para'>
                        ...
                        <p>I have personally committed to minimizing plastic usage in both packaging and shipments. Each item is received in compostable bags before being dispatched to customers in eco-friendly, recycled mailers. This dedication to sustainable practices underscores my approach to business.</p>
                    </div>
